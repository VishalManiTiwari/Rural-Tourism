...
const Destination = () => {
  ...
  return (
    <div className="min-h-screen px-4 py-10">
      <h1 className="text-3xl font-bold text-center text-blue-700 mb-6">Explore India</h1>
      ...
      <div className="flex justify-center gap-4 flex-wrap">
        {tabs.map((tab) => (
          <button
            ...
            className={`px-5 py-2.5 rounded-full transition-all duration-300 text-sm md:text-base font-semibold shadow-md ${
              activeTab === tab.id
